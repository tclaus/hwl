...
DefaultDirName={commonpf}\HWL2.5
...
AppPublisherURL=https://github.com/tclaus/hwl
...
Source: "DevExpress.language.DLL\de\DevExpress.Data.v11.2.resources.dll"; \
    DestDir: "{app}\TemplateDataBase"; \
...
Source: "HWL-Kernel\bin\Release\BouncyCastle.Cryptography.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\Google.Protobuf.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\K4os.Compression.LZ4.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\K4os.Compression.LZ4.Streams.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\K4os.Hash.xxHash.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\Microsoft.Bcl.AsyncInterfaces.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.Buffers.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.Configuration.ConfigurationManager.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.Diagnostics.DiagnosticSource.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.IO.Pipelines.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.Memory.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "HWL-Kernel\bin\Release\System.Numerics.Vectors.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "HWL-Kernel\bin\Release\ZstdSharp.dll"; DestDir: "{app}"; Flags: ignoreversion
