...
#Region "Directory functions"
        ...
        Public Function ListDirectory(ByVal directory As String) As List(Of String)
            ...
            str = str.Replace("" & Chr(13) & "" & Chr(10) & "", "" & Chr(13) & "").TrimEnd(Chr(13))
...
#Region "private supporting fns"
        ...
        Private Function AdjustDir(ByVal path As String) As String
            Return (IIf((path.StartsWith("/")), "", "/")).ToString() + path
        End Function
...
#Region "Properties"
        ...
        Public Property CurrentDirectory() As String
            Get
                ...
                Return _currentDirectory + (IIf((_currentDirectory.EndsWith("/")), "", "/")).ToString()
            End Get
            Set(ByVal value As String)
...
#Region "FTP Directory class"
    ...
    Public Class FTPdirectory
        ...
        Public Sub New(ByVal dir As String, ByVal path As String)
            For Each line As String In dir.Replace("" & Chr(10) & "", "").Split(System.Convert.ToChar(Chr(13)))
                'parse
                If line <> "" Then
